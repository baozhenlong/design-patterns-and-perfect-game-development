namespace GoF.Flyweight
{
    public class FlyweightTest
    {
        ...
        private static void UnitTest()
        {
            ...
            // 产生不共享的组件
            var unSharedConcreteFlyweight = flyweightFactory.GetUnSharedConcreteFlyweight("不共享的信息 1");
            ...
            // 产生不共享组件，并指定使用共享组件
            var unSharedConcreteFlyweight2 = flyweightFactory.GetUnSharedConcreteFlyweight("1", "", "不共享的信息 2");
